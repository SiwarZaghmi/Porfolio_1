          ...
          <div className="row skills-list">
            <div className="col">
              ...
              <p>
                ...
                Responsive Web Design, Python , Java , JEE
              </p>
            </div>
            <div className="col">
            <img scr="" alt=""/>
              <h4>Technology</h4>
              <p>Git, GitHub, Balsamic, Trello, Visual Code, Abode Photoshop / Premier </p>
            </div>
            <div className="col">
            <img scr="" alt=""/>
              <h4>Business Intelligence</h4>
              <p>PowerBi, Excel, Sql , Data Mining , Data learning</p>
            </div>
          </div>
        </div>
    </div>
